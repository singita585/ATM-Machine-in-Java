...
public class atm {
	public static void main(String[] args) {
		...
		while (session) {
			...
			int choice = sc.nextInt(); // assign the user's input to the choice variable

			// This switch block will handle one of five choices 

			switch (choice) {

				// case 1 deals with the user depositing money

				case 1:
					System.out.print("Enter (1) for Savings or (2) for Checking: ");
					int depositAccount = sc.nextInt(); // Keeps track of which account to deposit money to
				...
				// case 2 deals with the user withdrawing money from the atm

				case 2:
					System.out.print("\nEnter (1) for Savings or (2) for Checking: ");
					int withdrawAccount = sc.nextInt(); // Keeps track of which account to withdraw from
				...
				case 3:
					...
					if (transferAccount == 1) {
						...
						System.out.println("\nYou successfully transferred " + formatter.format(transferAmount) + " from Savings to Checking");
						...
						System.out.println("\nYou successfully transferred " + formatter.format(transferAmount) + " from Checking to Savings");
				...
				// case 4 outputs the balances of both Checking and Savings accounts	
...
class Account {
	...
	// Here we declare some variables that a bank account will have
